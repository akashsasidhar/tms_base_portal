...
import { Search, Plus, Loader2, MoreHorizontal, Eye, Pencil, Trash2, CheckSquare, Clock3, CheckCircle2 } from 'lucide-react';
...
export default function TasksPage() {
  ...
  const { data, isLoading, error } = useTasks({
    ...
    list_type: 'active', // Only show active tasks on main page
  });
